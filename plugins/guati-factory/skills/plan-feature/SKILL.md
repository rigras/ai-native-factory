...
- If `CONSTITUTION.md` exists at the repo root, load it — it is the authority on
  architecture and code standards (layering, patterns, testing strategy); the plan must
  comply with it, and any deliberate deviation needs an ADR
