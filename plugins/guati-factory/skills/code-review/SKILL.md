...
- CLAUDE.md
- `CONSTITUTION.md` (repo root, if present) — the authority on architecture and code
  standards; review findings cite the violated clause (layer separation, negative
  list, testing at the right level, naming)
- README.md
